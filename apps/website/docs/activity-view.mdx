---
title: "ActivityView (Share)"
description: "Share content using native share sheets on mobile and Web Share API on web with a single, unified API."
---
...
<Preview component="activity-view" title="Interactive Demo" />
...
```tsx
import { share, ActivityView, Text, View, Button } from "@native-ui-org/primitives";
