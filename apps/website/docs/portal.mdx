---
title: "Portal"
description: "Render components outside the React tree for overlays, modals, and tooltips that escape stacking contexts."
---
...
<Preview component="portal" title="Interactive Demo" />
