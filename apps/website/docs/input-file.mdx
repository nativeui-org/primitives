---
title: "InputFile"
description: "Cross-platform file input component for selecting images and files. Uses expo-image-picker on native platforms and native file input on web."
---
