---
title: "View"
description: "The foundational layout container for building cross-platform UIs with native performance and web accessibility."
---
...
<Preview component="view" title="Interactive Demo" />
